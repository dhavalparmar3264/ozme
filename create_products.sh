...
# Script to create 8 OZMÉ perfume products
# Note: Images should be uploaded separately via admin panel
...
EOF
  ...
  # Use multipart/form-data for product creation
  ...
  if [ "$SUCCESS" == "true" ]; then
    ...
    echo "✅ Created successfully (ID: ${PRODUCT_ID:0:12}...)"
    return 0
  else
...
echo ""
echo "📝 Note: Product images need to be uploaded separately via the admin panel:"
echo "   https://ozme.in/admin/products"
echo "   Edit each product and upload the provided images."
