                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-3 gap-8 lg:items-start">
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-100 p-8 shadow-lg lg:sticky lg:top-24 lg:max-h-[calc(100vh-8rem)] lg:overflow-y-auto">
                                {/* Title */}
                                <div className="mb-8">
